package com.xpressosystems.testjogl;
 ...
 * right/left)
 */
public class JOGL2Nehe10TexturedWorld3D implements GLEventListener, KeyListener {
    ...
    private float lookSideAngle = 0.0f;
...
//   private float textureRight;
     ...
     * The earth texture.
     */
    private Texture globeBGTexture = null;
    ...
    public static void main(String[] args) {
        ...
        JOGL2Nehe10TexturedWorld3D renderer = new JOGL2Nehe10TexturedWorld3D();
...
//      textureRight = textureCoords.right();
    ...
    public void display(GLAutoDrawable drawable) {
        ...
        gl.glRotatef(lookSideAngle, 0, 1.0f, 0);
        ...
        // Apply texture.
        globeBGTexture.enable(gl);
        globeBGTexture.bind(gl);
        gl.glPushMatrix();
        
        // Draw sphere (possible styles: FILL, LINE, POINT).
        GLUquadric sphere1 = glu.gluNewQuadric();

        glu.gluQuadricTexture(sphere1, true);
        ...
        gl.glLoadIdentity();  // reset the model-view matrix
        //gl.glTranslatef(0.f, 0.0f, 0.0f); // translate left and into the screen        
        //gl.glRotatef((float)(90), 1.0f, 0.0f, 0.0f); // rotate about the y-axis
    ...
    public void keyPressed(KeyEvent e) {
        //System.out.println("->keyPressed:"+e.getKeyCode()+" ("+e.getKeyChar()+"){"+e.getKeyLocation()+"}");
        switch (e.getKeyCode()) {
